        ...
        <div className="w-full py-5 col-span-2 md:col-span-1">
          ...
          {isEmployee ? (
            <div className="p-3 w-full h-full ">
              <h1 className="text-2xl mt-2 font-bold font-popins capitalize">SignIn as employee</h1>
              <LoginForm type="employee" />
            </div>
          ) : (
            <div className="w-full h-full p-3 rounded-lg cursor-pointer duration-75 ease-in-out">
              <h1 className="text-2xl mt-2 font-bold font-popins capitalize">SignIn as admin</h1>
